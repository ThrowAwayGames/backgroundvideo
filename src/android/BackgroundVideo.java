...
public class BackgroundVideo extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) throws JSONException {
        ...
        try {
            ...
            if (ACTION_START_RECORDING.equalsIgnoreCase(action)) {
                boolean recordAudio = args.getBoolean(8);
    ...
    private void Start(JSONArray args) throws JSONException {
        ...
        final boolean recordAudio = args.getBoolean(8);


        if (videoOverlay == null) {

            videoOverlay = new VideoOverlay(cordova.getActivity(), rh, rw);
            ...
            cordova.getActivity().runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        containerView.addView(videoOverlay, new ViewGroup.LayoutParams(w, h));
                        containerView.addView(barBottom, new ViewGroup.LayoutParams(w, barh+40));
